        ...
        right={
          <View style={styles.headerButtonRow}>
            {isSyncing ? (
              ...
              <Pressable style={styles.headerButton} onPress={handleSync} hitSlop={8} testID="sync-button">
            ...
            {isImporting ? (
              ...
              <Pressable style={styles.headerButton} onPress={handleImport} hitSlop={8} testID="import-button">
                <Ionicons name="cloud-download-outline" size={24} color={colors.surface} />
              </Pressable>
            )}
            <Pressable style={styles.headerButton} onPress={logout} hitSlop={8} testID="logout-button">
